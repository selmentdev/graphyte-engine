...
dotnet run --project .\generate\Generate.csproj --configuration Debug -Profile:".\profiles\main2.jsonc" -Platform:"Windows" -Generator:"FastBuild" -Toolchain:"MSVC" -OutputPath:".generated\fastbuild" -NoLogo
