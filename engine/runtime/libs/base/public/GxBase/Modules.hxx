...
namespace Graphyte
{
    ...
    enum struct ModuleType : uint32_t
    {
        ...
        /// Developer tool module. Not shipped with game.
        DeveloperTool,
    };
    ...
    /// and they don't require any code to be invoked at startup. Only module initialization is
    /// invoked.
    struct IModule
    {
    ...
    struct ModuleDescriptor final
    {
        ...
        /// System handle of loaded library.
        System::Library ModuleLibrary;

        /// Instance of IModule created by this library.
    ...
    public:
        ...
        /// @brief Loads specified module
        ///
        /// @remarks This function will break application execution when specified module couldn't
        /// be loaded.
        ///
        /// @param name Provides name of module to load.
        ///
