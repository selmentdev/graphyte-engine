...
namespace notstd
{
    ...
    public:
        flat_set() noexcept(std::is_nothrow_default_constructible_v<base_type>&& std::is_nothrow_default_constructible_v<container_type>) { }
        ...
        void swap(flat_set& other) noexcept(std::is_nothrow_swappable_v<base_type>&& std::is_nothrow_swappable_v<container_type>)
        {
            using std::swap;
            swap(
...
namespace notstd
{
    ...
    void swap(
        ...
        flat_set<Key, Compare, Container>& r) noexcept(noexcept(l.swap(r)))
    {
        l.swap(r);
    }
...
namespace notstd
{
    ...
    public:
        flat_map() noexcept(std::is_nothrow_default_constructible_v<base_type>&& std::is_nothrow_default_constructible_v<container_type>) { }
        ...
        void swap(flat_map& other) noexcept(std::is_nothrow_swappable_v<base_type>&& std::is_nothrow_swappable_v<container_type>)
        {
            using std::swap;
            swap(
                static_cast<base_type&>(*this),
...
namespace notstd
{
    ...
    public:
        flat_multiset() noexcept(std::is_nothrow_default_constructible_v<base_type>&& std::is_nothrow_default_constructible_v<container_type>) { }
        ...
        void swap(flat_multiset& other) noexcept(std::is_nothrow_swappable_v<base_type>&& std::is_nothrow_swappable_v<container_type>)
        {
            using std::swap;
            swap(
                static_cast<base_type&>(*this),
...
namespace notstd
{
    ...
    void swap(
        ...
        flat_multiset<Key, Compare, Container>& r) noexcept(noexcept(l.swap(r)))
    {
        l.swap(r);
    }
...
namespace notstd
{
    ...
    public:
        flat_multimap() noexcept(std::is_nothrow_default_constructible_v<base_type>&& std::is_nothrow_default_constructible_v<container_type>) { }
        ...
        void swap(flat_multimap& other) noexcept(std::is_nothrow_swappable_v<base_type>&& std::is_nothrow_swappable_v<container_type>)
        {
            using std::swap;
            swap(
                static_cast<base_type&>(*this),
...
namespace notstd
{
    ...
    void swap(
        ...
        flat_multimap<Key, Value, Compare, Container>& r) noexcept(noexcept(l.swap(r)))
    {
        l.swap(r);
    }
