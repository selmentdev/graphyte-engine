...
namespace Graphyte::Maths::Impl
{
    ...
    template <typename T>
    constexpr bool IsVector<T, std::void_t<typename T::IsVector>> = true;


    template <typename T, typename = void>
    constexpr bool IsMask = false;

    template <typename T>
    constexpr bool IsMask<T, std::void_t<typename T::IsMask>> = true;
    ...
    template <typename T>
    constexpr bool IsMatrix<T, std::void_t<typename T::IsMatrix>> = true;

    template <typename T, typename = void>
    constexpr bool IsGeometricVector = false;
