...
namespace Graphyte::Application::Impl
{
        ...
        SDL_Keycode keycode) noexcept
    {
        switch (keycode)
        {
            ...
            case SDLK_EXCLAIM:
                return Input::KeyCode::Exclaim;
            case SDLK_QUOTEDBL:
                return Input::KeyCode::DoubleQuote;
            case SDLK_HASH:
                return Input::KeyCode::Hash;
            //case SDLK_PERCENT???
            case SDLK_DOLLAR:
                return Input::KeyCode::Dollar;
            case SDLK_AMPERSAND:
                return Input::KeyCode::Ampersand;
            case SDLK_QUOTE:
                return Input::KeyCode::Quote;
            case SDLK_LEFTPAREN:
                return Input::KeyCode::LeftParen;
            case SDLK_RIGHTPAREN:
                return Input::KeyCode::RightParen;
            case SDLK_ASTERISK:
                return Input::KeyCode::Asterisk;
            case SDLK_PLUS:
                return Input::KeyCode::Plus;
            case SDLK_COMMA:
            ...
            case SDLK_COLON:
                return Input::KeyCode::Colon;
            case SDLK_SEMICOLON:
                return Input::KeyCode::Semicolon;
            case SDLK_LESS:
                return Input::KeyCode::Less;
            case SDLK_EQUALS:
                return Input::KeyCode::Equals;
            case SDLK_GREATER:
                return Input::KeyCode::Greater;
            case SDLK_QUESTION:
                return Input::KeyCode::Question;
            case SDLK_AT:
                return Input::KeyCode::At;
            ...
            case SDLK_CARET:
                return Input::KeyCode::Caret;
            case SDLK_UNDERSCORE:
                return Input::KeyCode::Underscore;
            case SDLK_BACKQUOTE:
            ...
            //SDLK_POWER
            case SDLK_KP_EQUALS:
                return Input::KeyCode::KeypadEquals;
            case SDLK_F13:
    ...
    static inline uint32_t ConvertKeyCode(
        const SDL_Keycode keycode) noexcept
    {
