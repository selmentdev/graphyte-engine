...
#error "Not implemented"
        ...
        siginfo_t* signal_info) noexcept
    {
        ...
        {
            GX_LOG(LogPlatform, Error, "Signal Info:\n");
            GX_LOG(LogPlatform, Error, "    signal: {}\n", signal_info->si_signo);
            GX_LOG(LogPlatform, Error, "      code: {}\n", signal_info->si_code);
            GX_LOG(LogPlatform, Error, "     errno: {}\n", signal_info->si_errno);
            GX_LOG(LogPlatform, Error, "      name: {}\n", GetSignalName(signal_info));
            ...
            switch (signal_info->si_signo)
            {
                ...
                case SIGBUS:
                {
                    ...
                    GX_LOG(LogPlatform, Error, "     upper: {}\n", signal_info->si_upper);
                    GX_LOG(LogPlatform, Error, "      pkey: {}\n", signal_info->si_pkey);
                    break;
                }
